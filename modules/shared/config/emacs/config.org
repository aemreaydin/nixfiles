...
#+BEGIN_SRC emacs-lisp
  (setq user-full-name "Emre AYDIN"
    user-mail-address "aeaydin1@gmail.com")
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  ;; Set path for darwin
  (when (system-is-mac)
    (setenv "PATH" (concat (getenv "PATH") ":/Users/emreaydn/.nix-profile/bin:/usr/bin"))
    (setq exec-path (append '("/Users/emreaydn/bin" "/profile/bin" "/Users/emreaydn/.npm-packages/bin" "/Users/emreaydn/.nix-profile/bin" "/nix/var/nix/profiles/default/bin" "/usr/local/bin" "/usr/bin") exec-path)))
#+END_SRC
